...
# 05:00 = 08:00 и 17:00 = 20:00 по Минску (утро и вечер, ровно 12ч между
# сводками). Оба часа входят в cron workflow ('0 5-20 * * *'), так что
# расписание не меняется — main.py сам определяет, какой прогон дайджестовый.
DIGEST_HOURS_UTC = (5, 17)
